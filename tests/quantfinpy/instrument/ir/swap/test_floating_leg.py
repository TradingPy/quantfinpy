...
def test_ir_floating_leg_ctor():
    ...
    leg_cash_flows = DuplicatedCashflowSchedule(cashflow_dates, floating_rate_cashflow)
    ...
    assert ir_floating_leg.cashflows == leg_cash_flows
    assert ir_floating_leg == IRFloatingLeg.build_unique_cashflow_definition(cashflow_dates, floating_rate_cashflow)
