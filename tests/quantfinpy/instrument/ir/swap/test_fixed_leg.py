...
def test_ir_fixed_leg_ctor():
    ...
    leg_cash_flows = CashflowSchedule.build_from_single_cashflow_definition(cashflow_dates, fixed_rate_cashflow)
    ...
    assert ir_fixed_leg == IRFixedLeg.build_from_single_cashflow_definition(cashflow_dates, fixed_rate_cashflow)
